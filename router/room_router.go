...
func (r *RoomRouter) InitRoomRouter(apiV1 *gin.RouterGroup) {
	...
	roomGroup := apiV1.Group("/room")
	{
		...
		roomGroup.GET("/getRoomInfo", v1.ApiGroupApp.GetRoomInfo)
		...
		roomGroup.DELETE("/deleteRoom", v1.ApiGroupApp.DeleteRoom)
		...
		roomGroup.PUT("/updateRoomInfo", v1.ApiGroupApp.UpdateRoomInfo)
	}
